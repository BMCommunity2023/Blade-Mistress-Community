...
void CBMLauncherDlg::OnButtonLaunch() 
{
	...
	if (m_rdoServer == kServerType_Default)
		args = strcat(args, "game.bmo-server.com");
	if (m_rdoServer == kServerType_DefaultFancy)
		args = strcat(args, "game.bmo-server.com");
...
void CBMLauncherDlg::OnRadioServerTest() { m_rdoServer = kServerType_DefaultFancy; }
...
{
	ShellExecute( NULL, "open", "https://supream3.github.io/", NULL, NULL, SW_SHOWNORMAL );	
}
