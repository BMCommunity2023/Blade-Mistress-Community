...
int GroundTestMode::Activate(void) // do this when the mode becomes the forbboClient->ground mode.
{
	...
	puma->LoadTexture("dat\\radarS1-0.png", &radarArtS1[0], 0);
	puma->LoadTexture("dat\\radarS1-1.png", &radarArtS1[1], 0);
	puma->LoadTexture("dat\\radarS1-2.png", &radarArtS1[2], 0);
	puma->LoadTexture("dat\\radarS1-3.png", &radarArtS1[3], 0);
	puma->LoadTexture("dat\\radarS1-4.png", &radarArtS1[4], 0);
	puma->LoadTexture("dat\\radarS1-5.png", &radarArtS1[5], 0);
	puma->LoadTexture("dat\\radarS1-6.png", &radarArtS1[6], 0);
	puma->LoadTexture("dat\\radarS1-7.png", &radarArtS1[7], 0);
	puma->LoadTexture("dat\\dot.png", &radarArtS1[8], 0xff000000);

	// realm of the dead

	puma->LoadTexture("dat\\radarS2-0.png", &radarArtS2[0], 0);
	puma->LoadTexture("dat\\radarS2-1.png", &radarArtS2[1], 0);
	puma->LoadTexture("dat\\radarS2-2.png", &radarArtS2[2], 0);
	puma->LoadTexture("dat\\radarS2-3.png", &radarArtS2[3], 0);
	puma->LoadTexture("dat\\radarS2-4.png", &radarArtS2[4], 0);
	puma->LoadTexture("dat\\radarS2-5.png", &radarArtS2[5], 0);
	puma->LoadTexture("dat\\radarS2-6.png", &radarArtS2[6], 0);
	puma->LoadTexture("dat\\radarS2-7.png", &radarArtS2[7], 0);
	puma->LoadTexture("dat\\dot.png", &radarArtS2[8], 0xff000000);

	//realm of dragons

	puma->LoadTexture("dat\\radarS3-0.png", &radarArtS3[0], 0);
	puma->LoadTexture("dat\\radarS3-1.png", &radarArtS3[1], 0);
	puma->LoadTexture("dat\\radarS3-2.png", &radarArtS3[2], 0);
	puma->LoadTexture("dat\\radarS3-3.png", &radarArtS3[3], 0);
	puma->LoadTexture("dat\\radarS3-4.png", &radarArtS3[4], 0);
	puma->LoadTexture("dat\\radarS3-5.png", &radarArtS3[5], 0);
	puma->LoadTexture("dat\\radarS3-6.png", &radarArtS3[6], 0);
	puma->LoadTexture("dat\\radarS3-7.png", &radarArtS3[7], 0);
	puma->LoadTexture("dat\\dot.png", &radarArtS3[8], 0xff000000);

	// lab 1

	puma->LoadTexture("dat\\radarS4-0.png", &radarArtS4[0], 0);
	puma->LoadTexture("dat\\radarS4-1.png", &radarArtS4[1], 0);
	puma->LoadTexture("dat\\radarS4-2.png", &radarArtS4[2], 0);
	puma->LoadTexture("dat\\radarS4-3.png", &radarArtS4[3], 0);
	puma->LoadTexture("dat\\radarS4-4.png", &radarArtS4[4], 0);
	puma->LoadTexture("dat\\radarS4-5.png", &radarArtS4[5], 0);
	puma->LoadTexture("dat\\radarS4-6.png", &radarArtS4[6], 0);
	puma->LoadTexture("dat\\radarS4-7.png", &radarArtS4[7], 0);
	puma->LoadTexture("dat\\dot.png", &radarArtS4[8], 0xff000000);

	// lab 2

	puma->LoadTexture("dat\\radarS5-0.png", &radarArtS5[0], 0);
	puma->LoadTexture("dat\\radarS5-1.png", &radarArtS5[1], 0);
	puma->LoadTexture("dat\\radarS5-2.png", &radarArtS5[2], 0);
	puma->LoadTexture("dat\\radarS5-3.png", &radarArtS5[3], 0);
	puma->LoadTexture("dat\\radarS5-4.png", &radarArtS5[4], 0);
	puma->LoadTexture("dat\\radarS5-5.png", &radarArtS5[5], 0);
	puma->LoadTexture("dat\\radarS5-6.png", &radarArtS5[6], 0);
	puma->LoadTexture("dat\\radarS5-7.png", &radarArtS5[7], 0);
	puma->LoadTexture("dat\\dot.png", &radarArtS5[8], 0xff000000);

	// lab 3

	puma->LoadTexture("dat\\radarS6-0.png", &radarArtS6[0], 0);
	puma->LoadTexture("dat\\radarS6-1.png", &radarArtS6[1], 0);
	puma->LoadTexture("dat\\radarS6-2.png", &radarArtS6[2], 0);
	puma->LoadTexture("dat\\radarS6-3.png", &radarArtS6[3], 0);
	puma->LoadTexture("dat\\radarS6-4.png", &radarArtS6[4], 0);
	puma->LoadTexture("dat\\radarS6-5.png", &radarArtS6[5], 0);
	puma->LoadTexture("dat\\radarS6-6.png", &radarArtS6[6], 0);
	puma->LoadTexture("dat\\radarS6-7.png", &radarArtS6[7], 0);
	puma->LoadTexture("dat\\dot.png", &radarArtS6[8], 0xff000000);
...
//	aLog.Log("GroundTestMode::Tick 2 **\n");
	...
	lastRealmID = bboClient->lastRealmID;
		...
		{   
			if (lastRealmID == REALM_ID_SPIRITS) // spirit realm
			{
				if (1 == mapState)
				{
					...
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS1[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS1[2]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS1[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS1[3]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS1[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				else
				{
					radarArtS1[5]->GetLevelDesc(0, &desc);
					RECT dRectRadar0 = { centerX, centerY - desc.Height, centerX + desc.Width, centerY };
					puma->DrawRect(radarArtS1[1], dRectRadar0, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS1[4]->GetLevelDesc(0, &desc);
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS1[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS1[6]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS1[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS1[7]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS1[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				...
				if ((bboClient->flashCounter / 4) & 1)
				{
					radarArtS1[8]->GetLevelDesc(0, &desc);
					RECT dRectDot = { centerX + 128 - ((centerCellX + 1) * 4),
									  centerY - 128 + ((centerCellY + 1) * 4),
									  centerX + 128 - ((centerCellX + 1) * 4) + desc.Width,
									  centerY - 128 + ((centerCellY + 1) * 4) + desc.Height };
			...
			else if (lastRealmID == REALM_ID_DEAD) // ROTD
			{
				if (1 == mapState)
				{
					...
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS2[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS2[2]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS2[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS2[3]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS2[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				else
				{
					radarArtS2[5]->GetLevelDesc(0, &desc);
					RECT dRectRadar0 = { centerX, centerY - desc.Height, centerX + desc.Width, centerY };
					puma->DrawRect(radarArtS2[1], dRectRadar0, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS2[4]->GetLevelDesc(0, &desc);
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS2[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS2[6]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS2[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS2[7]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS2[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				...
				if ((bboClient->flashCounter / 4) & 1)
				{
					radarArtS2[8]->GetLevelDesc(0, &desc);
					RECT dRectDot = { centerX + 128 - ((centerCellX + 1) * 4),
									  centerY - 128 + ((centerCellY + 1) * 4),
									  centerX + 128 - ((centerCellX + 1) * 4) + desc.Width,
									  centerY - 128 + ((centerCellY + 1) * 4) + desc.Height };
			...
			else if (lastRealmID == REALM_ID_DRAGONS) // realm of dragons
			{
				if (1 == mapState)
				{
					...
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS3[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS3[2]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS3[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS3[3]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS3[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				else
				{
					radarArtS3[5]->GetLevelDesc(0, &desc);
					RECT dRectRadar0 = { centerX, centerY - desc.Height, centerX + desc.Width, centerY };
					puma->DrawRect(radarArtS3[1], dRectRadar0, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS3[4]->GetLevelDesc(0, &desc);
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS3[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS3[6]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS3[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS3[7]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS3[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				...
				if ((bboClient->flashCounter / 4) & 1)
				{
					radarArtS3[8]->GetLevelDesc(0, &desc);
					RECT dRectDot = { centerX + 128 - ((centerCellX + 1) * 4),
									  centerY - 128 + ((centerCellY + 1) * 4),
									  centerX + 128 - ((centerCellX + 1) * 4) + desc.Width,
									  centerY - 128 + ((centerCellY + 1) * 4) + desc.Height };
			...
			if (lastRealmID == REALM_ID_LAB1) // lab1
			{
				if (1 == mapState)
				{
					...
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS4[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS4[2]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS4[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS4[3]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS4[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				else
				{
					radarArtS4[5]->GetLevelDesc(0, &desc);
					RECT dRectRadar0 = { centerX, centerY - desc.Height, centerX + desc.Width, centerY };
					puma->DrawRect(radarArtS4[1], dRectRadar0, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS4[4]->GetLevelDesc(0, &desc);
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS4[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS4[6]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS4[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS4[7]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS4[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				...
				if ((bboClient->flashCounter / 4) & 1)
				{
					radarArtS4[8]->GetLevelDesc(0, &desc);
					RECT dRectDot = { centerX + 128 - ((centerCellX + 1) * 4),
									  centerY - 128 + ((centerCellY + 1) * 4),
									  centerX + 128 - ((centerCellX + 1) * 4) + desc.Width,
									  centerY - 128 + ((centerCellY + 1) * 4) + desc.Height };
			...
			else if (lastRealmID == REALM_ID_LAB2) // lab2
			{
				if (1 == mapState)
				{
					...
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS5[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS5[2]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS5[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS5[3]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS5[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				else
				{
					radarArtS5[5]->GetLevelDesc(0, &desc);
					RECT dRectRadar0 = { centerX, centerY - desc.Height, centerX + desc.Width, centerY };
					puma->DrawRect(radarArtS5[1], dRectRadar0, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS5[4]->GetLevelDesc(0, &desc);
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS5[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS5[6]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS5[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS5[7]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS5[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				...
				if ((bboClient->flashCounter / 4) & 1)
				{
					radarArtS5[8]->GetLevelDesc(0, &desc);
					RECT dRectDot = { centerX + 128 - ((centerCellX + 1) * 4),
									  centerY - 128 + ((centerCellY + 1) * 4),
									  centerX + 128 - ((centerCellX + 1) * 4) + desc.Width,
									  centerY - 128 + ((centerCellY + 1) * 4) + desc.Height };
			...
			else if (lastRealmID == REALM_ID_LAB3) // lab3
			{
				if (1 == mapState)
				{
					...
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS6[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS6[2]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS6[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS6[3]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS6[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				else
				{
					radarArtS6[5]->GetLevelDesc(0, &desc);
					RECT dRectRadar0 = { centerX, centerY - desc.Height, centerX + desc.Width, centerY };
					puma->DrawRect(radarArtS6[1], dRectRadar0, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS6[4]->GetLevelDesc(0, &desc);
					RECT dRectRadar1 = { centerX - desc.Width, centerY - desc.Height, centerX, centerY };
					puma->DrawRect(radarArtS6[0], dRectRadar1, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS6[6]->GetLevelDesc(0, &desc);
					RECT dRectRadar3 = { centerX - desc.Width, centerY, centerX, centerY + desc.Height };
					puma->DrawRect(radarArtS6[2], dRectRadar3, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));

					radarArtS6[7]->GetLevelDesc(0, &desc);
					RECT dRectRadar2 = { centerX, centerY, centerX + desc.Width, centerY + desc.Height };
					puma->DrawRect(radarArtS6[3], dRectRadar2, 0xffffffff);//D3DCOLOR_ARGB(50,55,0,55));
				}
				...
				if ((bboClient->flashCounter / 4) & 1)
				{
					radarArtS6[8]->GetLevelDesc(0, &desc);
					RECT dRectDot = { centerX + 128 - ((centerCellX + 1) * 4),
									  centerY - 128 + ((centerCellY + 1) * 4),
									  centerX + 128 - ((centerCellX + 1) * 4) + desc.Width,
									  centerY - 128 + ((centerCellY + 1) * 4) + desc.Height };
	...
	*stream >> status;
	...
	case INVOBJ_BLADE:
		...
		*stream >> tame;
		...
		//if (bladeAgeCapped > 12000 && bboClient->cheats==0)  // when not cheating, lie about the age.
		//	bladeAgeCapped = 12000;

		if (bladeAge >= 130750)
			sprintf(&tempText[strlen(tempText)], "Ding! Shard is done.(%d)!\n", bladeAgeCapped);
		else if (bladeAge >= 55000)
